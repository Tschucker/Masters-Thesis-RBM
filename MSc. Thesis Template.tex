...
\listofnomenclature{l p{5cm} l}  % Include a list of Symbols (a three column table)
{
 ...
 $MinLowerEnvelope$ & Array of values corresponding to the minimum of each azimuth or elevation lower envelope calculation & Hz \\
 $BladeLength$ & Length of single rotor blade (radius of rotor) & meters \\
