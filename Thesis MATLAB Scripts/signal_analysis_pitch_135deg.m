...
files= dir('/Users/tschucker/Desktop/Thesis_data/Receiver_Off_Axis_7m/Altitude_200m/data_pitch_max15deg_135deg/*.csv');
num_files = length(files);
data = zeros(num_files,479000);
for i=1:num_files
     data(i,:)=transpose(csvread(strcat('/Users/tschucker/Desktop/Thesis_data/Receiver_Off_Axis_7m/Altitude_200m/data_pitch_max15deg_135deg/',files(i).name)));
end
