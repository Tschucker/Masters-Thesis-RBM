...
\textcolor{red}{FIGURE OUT WHAT TO PUT HERE FOR FADING COEFFICIENT?}

The power can then be calculated using

\textcolor{red}{FADING POWER?}

The superposition of each ray's faded power becomes the received signal.
...
\textcolor{red}{ADD MORE ABOUT RAY TRACING}
